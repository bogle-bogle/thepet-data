...
def extract_full_content_with_ocr(item):
    ...
    # 다양한 시작 패턴 리스트
    start_patterns = ["사용한 원료의 명칭", "원료", "사용원료","사용한 원료", "등록성분 주원료", "원재료명 및 함량","제조원료","사용한 원료의 명칭:", "원료:", "사용원료:","등록성분 주원료:", "원재료명 및 함량:","제조원료:","(사용한 원료의 명칭)", "(원료)", "(사용원료)","(등록성분 주원료)", "(원재료명 및 함량)","(제조원료)"]
